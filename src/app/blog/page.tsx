...
import { FiSearch, FiCalendar, FiUser, FiTag, FiClock } from 'react-icons/fi';
...
const blogPosts = [
  ...
  {
    id: 2,
    title: 'آموزش کامل Tailwind CSS از صفر تا صد',
    excerpt: 'Tailwind CSS یکی از محبوب‌ترین ابزارهای طراحی رابط کاربری است. در این آموزش گام به گام، همه چیز رو از نصب تا تکنیک‌های پیشرفته یاد می‌گیرید.',
    author: 'سارا محمدی',
    date: '۱۴۰۴/۰۹/۱۰',
    readTime: '۱۵ دقیقه',
    category: 'طراحی',
    tags: ['Tailwind', 'CSS', 'آموزش'],
    image:
      'data:image/jpeg;base64,',
    featured: true,
  },
  {
    id: 3,
    title: 'چگونه یک API امن با Node.js و Express بسازیم؟',
    excerpt: 'در این مقاله به امنیت API می‌پردازیم: احراز هویت با JWT، Rate Limiting، Validation و بهترین روش‌ها برای جلوگیری از حملات رایج.',
    author: 'محمد حسینی',
    date: '۱۴۰۴/۰۹/۰۵',
    readTime: '۱۲ دقیقه',
    category: 'بک‌اند',
    tags: ['Node.js', 'Express', 'امنیت', 'JWT'],
    image:
      'data:image/jpeg;base64,',
    featured: true,
  },
  {
    id: 4,
    title: 'بهینه‌سازی عملکرد در Next.js 14: تکنیک‌های پیشرفته',
    excerpt: 'با ویژگی‌های جدید Next.js 14 مثل Server Actions، Partial Prerendering و Streaming، چطور می‌تونید عملکرد سایتتون رو به سطح بعدی برسونید؟',
    author: 'رضا احمدی',
    date: '۱۴۰۴/۰۸/۳۰',
    readTime: '۱۰ دقیقه',
    category: 'Next.js',
    tags: ['Next.js', 'Performance', 'SSR'],
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRl-Q32WEfbkBFx0aiQLcCviPTRQ-8Q6BEA0w&s',
    featured: false,
  },
  {
    id: 5,
    title: 'معرفی ۱۰ کتاب ضروری برای توسعه‌دهندگان وب',
    excerpt: 'اگر می‌خواید مهارت‌های برنامه‌نویسی‌تون رو ارتقا بدید، این کتاب‌ها رو از دست ندید. از Clean Code تا Designing Data-Intensive Applications.',
    author: 'نیما کریمی',
    date: '۱۴۰۴/۰۸/۲۵',
    readTime: '۶ دقیقه',
    category: 'منابع',
    tags: ['کتاب', 'یادگیری', 'توسعه‌دهنده'],
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZIkMNyzlIk0WYcXVQZlqE5PJDJ06pkiSFXg&s',
    featured: false,
  },
  {
    id: 6,
    title: 'GraphQL در مقابل REST: کدام بهتر است؟',
    excerpt: 'مقایسه کامل GraphQL و REST API با مثال‌های واقعی. مزایا، معایب و سناریوهایی که هر کدوم مناسب‌تره.',
    author: 'علی رضایی',
    date: '۱۴۰۴/۰۸/۲۰',
    readTime: '۱۱ دقیقه',
    category: 'بک‌اند',
